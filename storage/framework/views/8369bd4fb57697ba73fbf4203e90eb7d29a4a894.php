    ...
    <div class=".col-12 .col-md-8 col d-flex justify-content-center">
      ...
      <section class="card profile-card mb-4 text-center" >
        <div class="avatar z-depth-1-half">
          <img src="/logo/<?php echo e($pass->logo); ?>" class="img-fluid" >
        </div>
        <!-- Card content -->

        <div class="card-body">
          <!-- Title + Website in the href area-->
          <h4 class="card-title"><strong><a href="https://www.ifs.com/"><?php echo e($pass->Com_name); ?></a></strong></h4>
          <p class="dark-grey-text text-justify"><?php echo e($pass->Com_description); ?></p>
          <hr>
          <div class ="row">
          <!-- Company Address -->
          <div class="col-lg-4 col-md-6 mb-4 text-muted">
            <i class="fas fa-map-marker-alt"></i> <?php echo e($pass->comp_address); ?>

          </div>

          <!-- Company Email -->
          <div class="col-lg-4 col-md-6 mb-4 text-muted">
            <i class="fas fa-envelope"></i> <?php echo e($pass->email); ?>

          </div>
          
          <!-- Company Contact Number -->
          <div class="col-lg-4 col-md-6 mb-4 text-muted">
            <i class="fas fa-phone"></i><?php echo e($pass->comp_tel); ?>
...
<?php echo $__env->make('layouts.cheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/compantUI/Company Profile View.blade.php ENDPATH**/ ?>