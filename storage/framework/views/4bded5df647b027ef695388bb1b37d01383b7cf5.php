...
<main>
  <div class="container-fluid">    
      ...
      <tbody>
        <?php $__currentLoopData = $noties_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noties_datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
         
          <td><?php echo e($noties_datas->date); ?></td>
          <td><?php echo e($noties_datas->time); ?></td>
          <td><?php echo e($noties_datas->title); ?></td>
          <td>
            <a href="/cc/career_counsellor_dashbord/noties/show/<?php echo e($noties_datas->id); ?>"><button type="button" class="btn btn-unique btn-rounded btn-sm px-2 m-0 col-md-3" title="View"><i class="far fa-eye"></i></button></a>
            <a href="/cc/career_counsellor_dashbord/noties/edit/<?php echo e($noties_datas->id); ?>"><button type="button" class="btn btn-blue btn-rounded btn-sm px-2 m-0 col-md-3" title="Edit"><i class="far fa-edit"></i></button></a>
            <a href="/cc/career_counsellor_dashbord/noties/delete/<?php echo e($noties_datas->id); ?>"><button type="button" class="btn btn-danger btn-rounded btn-sm px-2 m-0 col-md-3" title="Delete"><i class="far fa-trash-alt"></i></button></a>
            </td>
        </tr>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU Notices Table.blade.php ENDPATH**/ ?>