      ...
      <section class="mb-4">
        ...
        <div class="card">
          <div class="card-body d-flex justify-content-between">
            <h4 class="h4-responsive mt-3"><Strong><?php echo e($jobs->Jv_name); ?></Strong></h4>
      
            <div>
              <a href="/cc/career_counsellor_dashbord/job_vacancies/view/remove/<?php echo e($jobs->id); ?>" class="btn btn-danger">Delete</a>
              ...
              <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                ...
                <div class="card">
                  ...
                  <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2" data-parent="#accordionEx">
                    <div class="card-body">
                     <?php echo e($jobs->Jv_description); ?>
...
<?php echo $__env->make('layouts.cguheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU Find job Vacancy.blade.php ENDPATH**/ ?>