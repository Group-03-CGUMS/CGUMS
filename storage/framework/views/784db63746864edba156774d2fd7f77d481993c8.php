  ...
  <div class="d-flex change-mode">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            ...
            <?php $id= Crypt::encrypt(session('student_userId')); ?>
            <a class="dropdown-item" href="/welcome/change_password/<?php echo e($id); ?>">User Account</a>
          </div>
      </li>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h4 class="font-weight-bold "><?php echo e($jobCounts); ?></h4>
                </div>
              </div>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h4 class="font-weight-bold "><?php echo e($proCounts); ?></h4>
                </div>
              </div>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h4 class="font-weight-bold "><?php echo e($sessionCounts); ?> </h4>
                </div>
              </div>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h4 class="font-weight-bold "><?php echo e($applyjob); ?></h4>
                </div>
              </div>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <?php if(empty($jobs)): ?>
                  ...
                  <tr>
                    <?php if(($job->confirmed)==0): ?>
                    <td>Pending</td>
                    <?php else: ?>
                    <td class="info-color">Selected</td>
                    <?php endif; ?>
                    <td><?php echo e($job->jv_name); ?></td>
                    <td><?php echo e($job-> 	comp_name); ?></td>
                    <td class="date">
                      <span class="grey-text">
                      <?php echo e($job->updated_at); ?>
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tbody>
                      ...
                      <tr>
                      <td><?php echo e($programme->P_name); ?></td>
                      <td><?php echo e($programme->P_type); ?></td>
                      <td class="date">
                        <span class="grey-text">
                        <?php echo e($programme->P_date); ?> <?php echo e($programme->P_time); ?>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/studentUI/student_dashbord.blade.php ENDPATH**/ ?>