...
<main>
  <div class="container-fluid">    
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo e($data->P_date); ?> <?php echo e($data->P_time); ?></td>
          <td><?php echo e($data->P_name); ?></td>
          <td> <a href="/cc/career_counsellor_dashbord/programme/enrollment/<?php echo e($data->id); ?>"><button>View</button></a></td>
          <td>
          <a href="/cc/career_counsellor_dashbord/programme/show/<?php echo e($data->id); ?>"> <button type="button" class="btn btn-unique btn-rounded btn-sm px-2 m-0 col-md-3" title="VIEW"><i class="far fa-eye"></i></button></a>
          <a href="/cc/career_counsellor_dashbord/programme/edit/<?php echo e($data->id); ?>"> <button type="button" class="btn btn-blue btn-rounded btn-sm px-2 m-0 col-md-3" title="EDIT"><i class="far fa-edit"></i></button></a>
          <a href="/cc/career_counsellor_dashbord/programme/delete/<?php echo e($data->id); ?>"> <button type="button" class="btn btn-danger btn-rounded btn-sm px-2 m-0 col-md-3" title="DELETE"><i
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU Programmes Table.blade.php ENDPATH**/ ?>