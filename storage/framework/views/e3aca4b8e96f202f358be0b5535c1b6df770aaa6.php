...
<main>
  ...
  <?php if(Session::has('error_message')): ?>
            ...
            <?php endif; ?>
            <!-- Section: Docs link -->
            <?php $id= Crypt::encrypt($jvdata->id); ?>
            <form action="/company/company_dashbord/View_applications/accept_job/sendmail/<?php echo e($id); ?>" method="post">
              ...
              <div class="card text-center">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form5" class="form-control form-control-sm" name="st_name" value="<?php echo e($jvdata->st_name); ?>" readonly>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form5" class="form-control form-control-sm" name="st_email" value="<?php echo e($jvdata->st_email); ?>" readonly>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form5" class="form-control form-control-sm" name="position" value="<?php echo e($jvdata->jv_name); ?>" readonly>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="md-form form-sm mb-0">
                        <input type="text" id="form12" class="form-control form-control-sm" name="comp_name" value="<?php echo e($jvdata->comp_name); ?>" readonly>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form12" class="form-control form-control-sm" name="comp_email" value="<?php echo e($datas->email); ?>" readonly>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form3" class="form-control form-control-sm" name="comp_tel" value="<?php echo e($datas->comp_tel); ?>" readonly>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/compantUI/Company Schedule Interviews.blade.php ENDPATH**/ ?>