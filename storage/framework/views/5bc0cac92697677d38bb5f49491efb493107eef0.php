  ...
  <main>
    <div class="container-fluid">
            ...
            <section class="pb-5">
              ...
              <!-- Panel -->
              <?php $id= Crypt::encrypt($jobs->id); ?>
            <form action="/company/company_dashbord/profile_view/view_jobsVacancis/view/edit/save/<?php echo e($id); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form5" class="form-control form-control-sm" name="Job_name" value="<?php echo e($jobs->Jv_name); ?>">
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-6">
                      ...
                      <?php if("Accounting & Finance"==$jobs->Jv_type): ?>
                        ...
                        <?php elseif("Corparate Management/Analyst"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        ...
                        <option value="Sales & Marketing">Sales & Marketing</option>
                        <option value="Teaching/Academic/Research">Teaching/Academic/Research</option>
                        <?php elseif("Engineering(Mech/Civil/Elect/Marine)"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        <option value="Accounting & Finance" >Accounting & Finance</option>
                        <option value="Corparate Management/Analyst">Corparate Management/Analyst</option>
                        ...
                        <option value="Sales & Marketing">Sales & Marketing</option>
                        <option value="Teaching/Academic/Research">Teaching/Academic/Research</option>
                        <?php elseif("Healthcare/Nursing"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        <option value="Accounting & Finance" >Accounting & Finance</option>
                        <option value="Corparate Management/Analyst">Corparate Management/Analyst</option>
                        <option value="Engineering(Mech/Civil/Elect/Marine)">Engineering(Mech/Civil/Elect/Marine)</option>
                        ...
                        <option value="Sales & Marketing">Sales & Marketing</option>
                        <option value="Teaching/Academic/Research">Teaching/Academic/Research</option>
                        <?php elseif("HR & Admin"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        <option value="Accounting & Finance" >Accounting & Finance</option>
                        <option value="Corparate Management/Analyst">Corparate Management/Analyst</option>
                        <option value="Engineering(Mech/Civil/Elect/Marine)">Engineering(Mech/Civil/Elect/Marine)</option>
                        ...
                        <option value="Sales & Marketing">Sales & Marketing</option>
                        <option value="Teaching/Academic/Research">Teaching/Academic/Research</option>
                        <?php elseif("IT(Software/Network/Systems/QA)"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        <option value="Accounting & Finance" >Accounting & Finance</option>
                        <option value="Corparate Management/Analyst">Corparate Management/Analyst</option>
                        <option value="Engineering(Mech/Civil/Elect/Marine)">Engineering(Mech/Civil/Elect/Marine)</option>
                        ...
                        <option value="Sales & Marketing">Sales & Marketing</option>
                        <option value="Teaching/Academic/Research">Teaching/Academic/Research</option>
                        <?php elseif("Manufacturing/Operations"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        <option value="Accounting & Finance" >Accounting & Finance</option>
                        <option value="Corparate Management/Analyst">Corparate Management/Analyst</option>
                        <option value="Engineering(Mech/Civil/Elect/Marine)">Engineering(Mech/Civil/Elect/Marine)</option>
                        ...
                        <option value="Sales & Marketing">Sales & Marketing</option>
                        <option value="Teaching/Academic/Research">Teaching/Academic/Research</option>
                        <?php elseif("Sales & Marketing"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        <option value="Accounting & Finance" >Accounting & Finance</option>
                        <option value="Corparate Management/Analyst">Corparate Management/Analyst</option>
                        <option value="Engineering(Mech/Civil/Elect/Marine)">Engineering(Mech/Civil/Elect/Marine)</option>
                        ...
                        <option value="Teaching/Academic/Research">Teaching/Academic/Research</option>
                        <?php elseif("Teaching/Academic/Research"==$jobs->Jv_type): ?>
                        <option value="">Job Vacancy Area</option>
                        <option value="Accounting & Finance" >Accounting & Finance</option>
                        <option value="Corparate Management/Analyst">Corparate Management/Analyst</option>
                        <option value="Engineering(Mech/Civil/Elect/Marine)">Engineering(Mech/Civil/Elect/Marine)</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" class="form-control form-control-sm" value="<?php echo e(session('company_user')); ?>" name="comp_name" readonly>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-form">
                    <input placeholder="Deadline" type="text" id="date-picker-example" class="form-control datepicker" name="deadline" value="<?php echo e($jobs->Jv_deadline); ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form md-outline">
                      <textarea type="text" id="form101" class="form-control" rows="3"  name="companay_description"><?php echo e($jobs->comp_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form md-outline">
                      <textarea type="text" id="form101" class="form-control" rows="3" name="job_description"><?php echo e($jobs->Jv_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form md-outline">
                      <textarea type="text" id="form101" class="form-control" rows="3" name="responsibilities"> <?php echo e($jobs->Jv_respon); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form md-outline">
                      <textarea type="text" id="form101" class="form-control" rows="3" name="qualifications"> <?php echo e($jobs->Jv_que); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form md-outline">
                      <textarea type="text" id="form101" class="form-control" rows="3" name="additional"> <?php echo e($jobs->Jv_addinfo); ?></textarea>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/compantUI/edit_vacancies.blade.php ENDPATH**/ ?>