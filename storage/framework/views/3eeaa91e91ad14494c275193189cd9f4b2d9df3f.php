          ...
          <ul class="nav navbar-nav nav-flex-icons ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link waves-effect"> <span
                  class="clearfix d-none d-sm-inline-block"><?php echo e(session('counsellor_user')); ?></span></a>
            </li>
            <li class="nav-item dropdown">
              ...
              <?php $id= Crypt::encrypt(session('counsellor_userId')); ?>
                <a class="dropdown-item" href="/cc/career_counsellor_dashbord/change_password/<?php echo e($id); ?>">User Account</a>
              </div>
            </li>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h3 class="font-weight-bold "><?php echo e($comp_count); ?></h3>
                </div>
              </div>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h3 class="font-weight-bold "><?php echo e($prog_count); ?></h3>
                </div>
              </div>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h3 class="font-weight-bold "><?php echo e($ccsession_count); ?></h3>
                </div>
              </div>
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  ...
                  <h3 class="font-weight-bold "><?php echo e($all_session-$ccsession_count); ?></h3>
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="card text-center mb-4 pt-4 pb-3 blue-gradient white-text">
              ...
              <h2 class="h2-responsive"><?php echo e($all_student); ?></h2>
            </div>
          ...
          <div class="col-lg-3">
            <div class="card text-center mb-4 pt-4 pb-3 peach-gradient white-text">
              ...
              <h2 class="h2-responsive"><?php echo e($all_cgu); ?></h2>
            </div>
            </div>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU Dashboard.blade.php ENDPATH**/ ?>