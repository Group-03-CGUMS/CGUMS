    ...
    <div class="col-md-12">
      ...
      <div class="card card-image"
        ...
        <div class="text-white text-center align-items-center rgba-black-strong py-5 px-4">
          <div>
            <!-- Programme Type-->
            <h5 class="text-center"><?php echo e($programme_data->P_type); ?></h5>
            <!-- Programme Title-->
            <h3 class="card-title pt-4 pb-3 font-weight-bold "><strong><?php echo e($programme_data->P_name); ?></strong></h3>
            <h5 class="text-center"><p><?php echo e($programme_data->P_details); ?></p></h5>
            <hr style="height:1px;border-width:0;color:gray;background-color:rgb(255, 255, 255)">
            <p><!-- Programme Date-->
              Date : <?php echo e($programme_data->P_date); ?><br>
              <!-- Programme Time-->
              Time : <?php echo e($programme_data->P_time); ?><br>
              <!-- Programme Venue-->
              Venue : <?php echo e($programme_data->P_venue); ?><br><br>
              <!-- Resource Person/Company-->
              Conducted by :<?php echo e($programme_data->P_resourceperson); ?><br>
              <!-- Participant Limit-->
              Participant Limit : <?php echo e($programme_data->capacity); ?> Students [first come first serve basis] <br></p>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU Programme View.blade.php ENDPATH**/ ?>