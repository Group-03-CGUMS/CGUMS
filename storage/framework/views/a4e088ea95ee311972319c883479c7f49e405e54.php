          ...
          <div class="card card-cascade cascading-admin-card">
            ...
            <div class="admin-up">
              ...
              <div class="data">
                ...
                <h4 class="font-weight-bold "><?php echo e($ajCounts); ?></h4>
              </div>
            </div>
          ...
          <div class="card card-cascade cascading-admin-card">
            ...
            <div class="admin-up">
              ...
              <div class="data">
                ...
                <h4 class="font-weight-bold "><?php echo e($jvCounts); ?></h4>
              </div>
            </div>
          ...
          <div class="card card-cascade cascading-admin-card">
            ...
            <div class="admin-up">
              ...
              <div class="data">
                ...
                <h4 class="font-weight-bold "><?php echo e($selectjobCounts); ?></h4>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-12">
          ...
          <div class="card text-center mb-4 pt-4 pb-3 blue-gradient white-text">
            ...
            <h4 class="h4-responsive"><?php echo e($ajCounts -$newcomer); ?> New Applicants</h4>
          </div>
          <div class =".col-6">
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/compantUI/company_dashbord.blade.php ENDPATH**/ ?>