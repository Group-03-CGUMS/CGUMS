        ...
        <ul class="nav navbar-nav nav-flex-icons ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
              ...
              <?php $id= Crypt::encrypt(session('company_userId')); ?>
              <a class="dropdown-item" href="/company/company_dashbord/update/change_password/<?php echo e($id); ?>">User Account</a>
            </div>
          </li>
      ...
      <div class="col-lg-12">
        ...
        <div class="card card-cascade narrower">
          ...
          <?php if(Session::has('error_message')): ?>
            ...
            <!-- Edit Form -->
           <form action="/company/company_dashbord/update/change_password/savedata/<?php echo e(session('company_userId')); ?>" method="post">
            <?php echo e(csrf_field()); ?>

              <!-- First row -->
              <input type="hidden" class="form-control" id="exampleInputPassword1" value="<?php echo e(session('company_userId')); ?>" name="name">
                <div class="row">
                <!-- Second column -->
                <div class="col-md-6">
                  <div class="md-form mb-0">
                    <input type="text" id="form2" class="form-control form-control-sm" value="<?php echo e(session('company_user')); ?>" readonly>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/compantUI/Company User Profile.blade.php ENDPATH**/ ?>