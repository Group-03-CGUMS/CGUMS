      ...
      <div class="col-lg-12">
        ...
        <div class="card card-cascade narrower">
          ...
          <?php if(Session::has('error_message')): ?>
            ...
            <!-- Edit Form -->
            <form method="post" action="/welcome/change_password/savedata/<?php echo e($student_user_data->id); ?>">
              ...
              <input type="hidden" class="form-control " id="exampleInputPassword1" value="<?php echo e($student_user_data->id); ?>" name="name">
                ...
                <div class="col-md-6">
                  <div class="md-form mb-0">
                    <input type="text" id="form2" class="form-control form-control-sm" value="<?php echo e(session('student_id')); ?>" readonly>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/auth/student_user_change_password.blade.php ENDPATH**/ ?>