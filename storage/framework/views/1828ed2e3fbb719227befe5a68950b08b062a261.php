  ...
  <div class="container-fluid">    
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <?php if(($company->is_deleted)==1): ?>
            <a href="/cc/career_counsellor_dashbord/company/view/deactive/<?php echo e($company->id); ?>"><button type="button" class="btn btn-danger btn-rounded btn-sm px-2 m-0 col-md-10">Deactivate</button></a>
            <?php else: ?>
            <a href="/cc/career_counsellor_dashbord/company/view/active/<?php echo e($company->id); ?>"><button type="button" class="btn btn-primary btn-rounded btn-sm px-2 m-0 col-md-10">activate</button></a>
            <?php endif; ?>
          </td>
        </tr>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU View Companies.blade.php ENDPATH**/ ?>