    ...
    <section class="pb-5">
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          ...
          <h4 class="h3-responsive text-center font-weight-bold dark-grey-text"><?php echo e($noties_data->title); ?></h4>
              <hr>
              <div class="row">
              <div class="col-md-12">
                  <p class="text-justify"><?php echo e($noties_data->note); ?>

                  </p>

                  <p class="text-justify"><a href="<?php echo e($noties_data->link1); ?>"><?php echo e($noties_data->link1); ?></a></p>
                  <p class="text-justify"><a href="<?php echo e($noties_data->link2); ?>"><?php echo e($noties_data->link2); ?></a></p>
        ...
        <div class="col-md-4">
          ...
          <div class="text-center">
            <a href="/cc/career_counsellor_dashbord/noties/view/<?php echo e($noties_data->attachment); ?>" class="btn blue-gradient btn m-0">Download
              Attachment</a>
          </div>
        </div>
        <?php else: ?>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU View Notice.blade.php ENDPATH**/ ?>