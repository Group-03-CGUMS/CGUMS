    ...
    <div class="col-lg-12">
      ...
      <div class="card card-cascade narrower">
        ...
        <div class="card-body card-body-cascade">
          ...
          <!-- Edit Form -->
          <form action="/cc/career_counsellor_dashbord/change_password/savedata/<?php echo e($counsellor_user_data->id); ?>" method="post">
            <!-- First row -->
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="md-form mb-0">
                  <input type="text"  class="form-control validate" value="<?php echo e($counsellor_user_data->name); ?>" readonly>
...
<?php /**PATH G:\IJSE\web\Laravel\Final Project\CGUMS\resources\views/cgu/CGU User Profile.blade.php ENDPATH**/ ?>